<form id="form_tambah">
    ...
    <div class="form-group">
        <label>Email:</label>
        <input name="email" type="text" class="form-control" placeholder="Masukan Alamat Email" required>
    </div>
    ...
    <div class="form-group">
        ...
        <input name="ttl" type="text" class="form-control" placeholder="Masukan Tempat Dan Tanggal Lahir" required>
    </div>
