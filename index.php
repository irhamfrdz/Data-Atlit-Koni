...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>KONI Kota Serang</b></span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
              <li><a href="index.php?page=atlit"><i class="fa fa-info-circle"></i> <span>Anggota Atlit</span></a></li>
              <li><a href="index.php?page=barang"><i class="fa fa-random"></i> <span> Anggota Atlit  Mengikuti Lomba</span></a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
              <li><a href="index.php?page=stok-saat-ini"><i class="fa fa-info-circle"></i> <span>Inventaris Barang KONI</span></a></li>
              <li><a href="index.php?page=inventaris-kendaraan"><i class="fa fa-random"></i> <span> Inventaris Kendaraan KONI</span></a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
              <li><a href="index.php?page=supplier"><i class="fa fa-user"></i> <span>Pelatih</span></a></li>
              <li><a href="index.php?page=kategori"><i class="fa fa-bars"></i> <span>Cabang Olahraga</span></a></li>
      ...
      if(isset($_GET['page'])){
        ...
        switch ($page) {
              ...
              case 'input-barang-keluar':
                ...
                break;
              case 'stok-saat-ini':
                include "pages/stok/index.php";
                break;
              case 'inventaris-kendaraan':
                include "pages/inventaris-kendaraan/index.php";
                break;
              case 'laporan-barang':
              ...
              case 'barang':
                ...
                break;
              case 'atlit':
                include "pages/anggota-atlit/index.php";
                break;
              case 'supplier':
